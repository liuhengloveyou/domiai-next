...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div
        id="features"
        className="bg-gradient-to-b from-blue-500/5 via-purple-500/5 to-background py-8 md:py-16 scroll-mt-16"
      >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
                    ...
                    <Card className="p-3 md:p-4 lg:p-6 h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-background/60 backdrop-blur border-primary/10">
                      ...
                      <div className="flex mb-2 md:mb-3">
                        {[...Array(testimonial.rating)].map((_, i) => (
                          <Star
                            key={i}
                            className="h-3 w-3 md:h-4 md:w-4 fill-primary text-primary mr-0.5"
                          />
                        ))}
                      </div>
            ...
            <button
              ...
              onClick={() =>
                setActiveTestimonialIndex((current) =>
                  current === testimonials.length - (isMobile ? 1 : 3)
                    ? 0
                    : current + 1
                )
              }
          ...
          <div className="flex justify-center gap-1.5 md:gap-2 mt-4 md:mt-8">
            {[
              ...Array(
                isMobile ? testimonials.length : testimonials.length - 2
              ),
            ].map((_, index) => (
              <button
                key={index}
